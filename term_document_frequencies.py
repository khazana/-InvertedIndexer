...
bigram_term_frequency = terms_frequency(bigram_dict)
...
write_dict_to_file(bigram_term_frequency, get_var_name(bigram_term_frequency)[0])
...
bigram_doc_frequency = doc_frequency(bigram_dict)
...
write_dict_to_file(bigram_doc_frequency, get_var_name(bigram_doc_frequency)[0])
